//-----------------------------------------------------------------------
// <copyright file="ColumnsDialogCommand.cs" company="Тепляшин Сергей Васильевич">
...
// <time>14:51</time>
// <summary>Defines the ColumnsDialogCommand class.</summary>
//-----------------------------------------------------------------------
...
namespace VocabularyTest.Addons.VocabularyWindow
{
    ...
    public class ColumnsDialogCommand : ICommand
    {
        ...
        {
            if (ColumnsDialog.ShowDialog((IWin32Window)owner, theme))
            {
